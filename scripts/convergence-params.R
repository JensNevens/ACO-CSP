...
#file.names <- c("data/convergence-algo/data-convergence-as.txt",
#                "data/convergence-algo/data-convergence-eas.txt",
#                "data/convergence-algo/data-convergence-ras.txt",
#                "data/convergence-algo/data-convergence-mmas.txt",
#                "data/convergence-algo/data-convergence-acs.txt")
